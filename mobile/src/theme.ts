export const lightTheme = {
    ...
    typography: {
        ...
        h2: { fontSize: 28, fontWeight: '600' as const, color: '#0F172A' },
        h3: { fontSize: 22, fontWeight: '600' as const, color: '#0F172A' },
        bodyLarge: { fontSize: 20, fontWeight: '400' as const, color: '#475569', lineHeight: 28 },
        body: { fontSize: 18, fontWeight: '400' as const, color: '#475569', lineHeight: 26 },
        caption: { fontSize: 14, fontWeight: '400' as const, color: '#94A3B8' },
        buttonText: { fontSize: 20, fontWeight: '600' as const },
    }
};
