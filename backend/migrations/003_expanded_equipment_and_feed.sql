...
CREATE TABLE feed_catalog (
    ...
    cost_per_kg_inr DECIMAL(10, 2) NOT NULL,
    packaging_size_kg INTEGER,
    suitable_for VARCHAR(100), -- Species or Stage
    is_active BOOLEAN DEFAULT TRUE,
    created_at TIMESTAMPTZ DEFAULT NOW(),
    updated_at TIMESTAMPTZ DEFAULT NOW()
);

CREATE INDEX idx_feed_type ON feed_catalog(feed_type);
...
-- Trigger for feed_catalog
CREATE TRIGGER update_feed_catalog_updated_at 
